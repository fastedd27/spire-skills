...
4. Mechanical enforcement (the hooks) requires `python3` on PATH; without it the pipeline degrades to the v0.1 prose-only write boundaries — see `hooks/README-hooks.md`.
